...
import json
import time
from prompt.base_prompt import BUG_PROMPT, BUG_PROMPT_CoT, BUG_PROMPT_Reasoning
...
if __name__ == '__main__':
    ...
    # responser = Mistral()
    # model_type='Deepseek-Qwen-still-14B'
    # responser = Deepseek()
    ...
    for item in tqdm(ml_dataset):
        ...
        with open(f"./result/{model_type}-cot.jsonl", 'a+') as file:
