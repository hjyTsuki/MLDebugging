...
model_type = "Qwen/Qwen2.5-Coder-7B-Instruct"
...
# model_type = "gemini-2.0-flash-thinking-exp-1219"
model_type = "HiSpeed/DeepSeek-R1"
# model_type = "Qwen/QwQ-32B"
if __name__ == '__main__':
    ...
    for item in tqdm(ml_dataset)
        ...
        with open(f"./result/{model_type.replace('HiSpeed/', '')}-cot.jsonl", 'a+') as file:
